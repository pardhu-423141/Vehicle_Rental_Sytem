...
export default function RideHistory() {
  ...
  const cancelBooking = async (bookingId: string) => {
    ...
    try {
      await api.patch(`/bookings/cancel/${bookingId}`); // adjust endpoint as needed
                  ...
                  <div className="flex flex-wrap items-center gap-3 pt-4 border-t border-white/5">
                    {ride.status === 'COMPLETED' ? (
                      ...
                      <button
                        ...
                        className="flex items-center gap-2 px-4 py-2 bg-red-500/10 hover:bg-red-500/20 text-red-400 text-sm font-bold rounded-xl transition border border-red-500/20 disabled:opacity-50"
                      >
